...
import { useTranslations } from '@/Composables/useTranslate'
        ...
        <div v-if="menu" class="absolute right-0 mt-2 min-w-max bg-wd-l-4 dark:bg-wd-d-6 rounded-md shadow-lg z-10 overflow-hidden">
            <ul>
                <li v-for="(lang, code) in languages" :key="code">
                    <button @click="translate(code)" class="w-full flex items-center px-4 py-2 hover:bg-wd-l-5 dark:hover:bg-wd-4 transition-all">
