...
// Define los idiomas disponibles y la ruta a su ícono (asegúrate de que existan en tu carpeta public)
const languages = {
...
<template>
    <div class="relative inline-block text-left">
        ...
        <!-- Dropdown con la lista de idiomas -->
        <div v-if="menu" class="absolute right-0 mt-2 min-w-max bg-wd-l-4 dark:bg-wd-d-6 rounded-md shadow-lg z-10 overflow-hidden">
            <ul>
                <li v-for="(lang, code) in languages" :key="code">
                    <button @click="changeLanguage(code)" class="w-full flex items-center px-4 py-2 hover:bg-wd-l-5 dark:hover:bg-wd-d-7 transition-all">
